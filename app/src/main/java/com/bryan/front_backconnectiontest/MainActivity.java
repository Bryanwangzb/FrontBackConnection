...
public class MainActivity extends AppCompatActivity {
    ...
    private void getPosts() {
        ...
        Call<List<Post>> call = jsonPlaceHolderApi.getPosts(parameters); //this is request to get data from service
        // here means execute
    ...
    private void getComments() {
        ...
        Call<List<Comment>> call = jsonPlaceHolderApi.
                getComment("posts/3/comments"); // could paste whole url
    ...
    private void createPost() {
        ...
        call.enqueue(new Callback<Post>() {
            ...
            public void onResponse(Call<Post> call, Response<Post> response) {
                ...
                content += "Title: " + postResponse.getText() + "\n";
